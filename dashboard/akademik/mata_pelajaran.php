                        ...
                        <tbody>
                            <?php foreach ($mata_pelajaran as $mp): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($mp['spesialisasi'] ?? '-'); ?></td>
                                    <td><?php echo date('d/m/Y', strtotime($mp['created_at'])); ?></td>
                                    <td>
                                        <button type="button" class="btn btn-sm btn-warning me-1" data-bs-toggle="modal" data-bs-target="#editMataPelajaranModal" 
                                                onclick="editMataPelajaran(<?php echo htmlspecialchars(json_encode($mp)); ?>)">
