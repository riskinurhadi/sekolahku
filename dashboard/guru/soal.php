            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="empty-state text-center py-5">
                        ...
                        <h5 class="mt-3 mb-2" style="font-size: 1rem; font-weight: 600; color: #1e293b;">Belum ada soal</h5>
                        <p class="text-muted mb-3" style="font-size: 0.875rem; color: #64748b;">Mulai dengan menambahkan soal baru</p>
                        <a href="tambah_soal.php" class="btn btn-primary" style="padding: 8px 16px; font-size: 13px; font-weight: 500; border-radius: 8px;">
                            <i class="bi bi-plus-circle me-1" style="font-size: 14px;"></i> Tambah Soal Baru
                        </a>
                    </div>
                <?php endif; ?>
            </div>
