<?php
$page_title = 'Ujian Akhir Semester (UAS)';
...
// Get jadwal UAS untuk kelas siswa
...
if ($check_table && $check_table->num_rows > 0 && $kelas_id) {
    ...
    if ($check_column && $check_column->num_rows > 0) {
        $stmt = $conn->prepare("SELECT ju.*, s.id as soal_id, s.judul as judul_soal, s.deskripsi, s.waktu_pengerjaan, mp.nama_pelajaran, u.nama_lengkap as nama_guru, pengawas.nama_lengkap as nama_pengawas,
            ...
            WHERE ju.kelas_id = ? AND s.tipe_ujian = 'uas'
...
<div class="page-header">
    <div>
        <h2>Ujian Akhir Semester (UAS)</h2>
        <p>Daftar jadwal UAS yang harus Anda ikuti</p>
    </div>
</div>
            ...
            <div class="card-body">
                ...
                <?php elseif (count($jadwal_list) > 0): ?>
                    <div class="table-responsive">
                        <table id="uasTable" class="table table-hover" style="width:100%">
                            <thead>
                                <tr>
                ...
                <?php else: ?>
                    <div class="empty-state text-center py-5">
                        ...
                        <h5 class="mt-3 mb-2" style="font-size: 1rem; font-weight: 600; color: #1e293b;">Belum ada jadwal UAS</h5>
                        <p class="text-muted mb-3" style="font-size: 0.875rem; color: #64748b;">Jadwal UAS akan muncul setelah akademik mengatur jadwal ujian</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
